 ...
 * LinkedList.java In.java StdOut.java Data files:
 ...
 * vertex-indexed array of {@link LinkedList} objects. All operations take
 * constant time (in the worst case) except iterating over the vertices adjacent
 * to a given vertex, which takes time proportional to the number of such
 * vertices.
 * <p>
...
public class Graph
{
	...
	/**
	 * @return the max degree of this graph
	 */
	...
	public String toString()
	{
		...
		s.append("Degree:" + maxDegree() + NEWLINE + V + " vertices, " + E + " edges " + NEWLINE);
		for (int v = 0; v < V; v++)
		{
			s.append(v + ": ");
			for (int w : adj[v])
